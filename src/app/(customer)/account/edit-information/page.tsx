									...
									<div className="purchase-item__product-detail">
										...
										<div className="purchase-item__product-name">
											...
											<div className="userSex">
												<select id="userSex" name="userSex" title="Chọn giới tính">
										...
										<div className="popup__button">
											<a href="/account/information" className="btn btn--outlined pri btn-cancel-edit">Hủy</a>
											<button type="submit" id="saveButton" className="btn btn--filled pri">Lưu</button>
										</div>
									</div>
								</div>
							</div>
