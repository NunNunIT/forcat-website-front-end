			...
			<div className={cx("purchase-item__main")}>
				<div className={cx("purchase-item__element")}>
					<div className={cx("purchase-item__product-detail")}>
						...
						<div className={cx("purchase-item__product-name")}>
							<label htmlFor="userName">
								Tên người dùng:
								<span className={cx("red-start")}>*</span>
							</label>
						...
						<div className={cx("purchase-item__product-name")}>
							...
							<div className={cx("userBirth")} onClick={showDatePicker}>
						...
						<div className={cx("purchase-item__product-name")}>
							...
							<div className={cx("userSex")}>
								<select className={cx("localSelect")} id="userSex" name="userSex" title="Chọn giới tính">
						...
						<div className={cx("popup__button")}>
							<Link href="/account/information" className={cx("btn btn--outlined pri btn-cancel-edit")}>Hủy</Link>
							<button type="submit" id="saveButton" className={cx("btn btn--filled pri localButton")}>Lưu</button>
						</div>
					</div>
				</div>
			</div>
