...
const articleData: IArticleProps = {
  ...
  article_description: [
    ...
    { type: 'p', content: 'Đặc điểm sản phẩm: Nutriplus Gel Virbac là một sản phẩm dinh dưỡng cao cấp chứa nhiều vitamin, khoáng chất và các chất bổ sung khác. Sản phẩm có kết cấu dạng gel, dễ sử dụng.' },
    { type: 'p', content: 'Ứng dụng và công dụng: Hỗ trợ tăng cân, phục hồi sức khỏe sau bệnh, bổ sung năng lượng cho chó mèo trong quá trình tập luyện hoặc mang thai.' },
    { type: 'p', content: 'Đánh giá: Nutriplus Gel Virbac được đánh giá cao về chất lượng và hiệu quả sử dụng.' },
    { type: 'img', url: '/imgs/news-page/news-page-000001-01.png', alt: 'Gel dinh dưỡng cho mèo Nutriplus', caption: 'Gel dinh dưỡng cho mèo Nutriplus' },
    { type: 'h3', content: 'B. Felovite II' },
    { type: 'p', content: 'Đặc điểm sản phẩm: Felovite II là gel dinh dưỡng chứa vitamin, khoáng chất và taurine, đặc biệt phù hợp cho mèo.' },
    { type: 'p', content: 'Ứng dụng và công dụng: Giúp bổ sung năng lượng, hỗ trợ hệ tiêu hóa và tăng cường hệ miễn dịch cho mèo.' },
    { type: 'p', content: 'Đánh giá: Felovite II được đánh giá là sản phẩm hiệu quả, giá cả hợp lý.' },
    { type: 'h2', content: 'Kết luận' },
    { type: 'p', content: 'Việc sử dụng gel dinh dưỡng cho chó mèo đóng vai trò quan trọng trong việc cải thiện sức khỏe, phát triển toàn diện của thú cưng. Bạn nên lựa chọn các sản phẩm từ các địa chỉ uy tín và chính hãng để đảm bảo chất lượng. Đồng thời, hãy tham khảo ý kiến của bác sĩ thú y để xác định nhu cầu dinh dưỡng phù hợp và cách sử dụng gel dinh dưỡng đúng cách cho chó mèo của bạn.' },
    { type: 'h3', content: 'Khi mua gel dinh dưỡng, bạn có thể tham khảo các tiêu chí sau để đưa ra quyết định' },
    { type: 'p', content: 'Cuối cùng, việc chăm sóc sức khỏe và dinh dưỡng cho chó mèo là một quá trình dài hơi, nên hãy kiên nhẫn và chú ý theo dõi sự thay đổi của thú cưng để điều chỉnh chế độ dinh dưỡng khi cần thiết.' },
    { type: 'p', content: 'Chúc bạn và thú cưng của mình luôn khỏe mạnh và hạnh phúc!' },
  ]
};
...
const convertJSONToDOM = (props: {
  ...
  return (
    <>
      ...
      {props.type == 'img' && <figure>
        <div className="img-container">
          <Image src={props.url ?? 'a'}
            alt={props?.alt ?? 'alt'}
            fill
          />
        </div>
    ...
    <main>
      <article className="news-page__article">
        <div className="new-page__article--info">
          ...
          <address>
            <time className="news-page__date" dateTime={article_date}>{articleDateConverted}</time>
            {" - Viết bởi: "}
      ...
      <aside className="news-page__aside">
